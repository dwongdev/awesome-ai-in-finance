...
- [CoinPaprika API](https://api.coinpaprika.com) - Cryptocurrency market data API with prices, volume, market cap, and OHLCV for 12,000+ coins. Free tier, no API key required. Includes MCP server for AI agent integration.
- [DexPaprika API](https://api.dexpaprika.com) - DEX and DeFi data API: pool data, token prices, OHLCV, and trade history across 36 chains. Free tier, no API key required. Includes MCP server for AI agents.
